...
const TABLE_LAYOUT = [
  { id: 1, cx: 140, cy: 160, seats: 2, zone: 'INTERIOR' },
  ...
  { id: 6, cx: 750, cy: 160, seats: 4, zone: 'EXTERIOR' },
...
function renderFloorPlan() {
  ...
  svg.innerHTML = `
    <rect x="20" y="20" width="410" height="380" rx="8"
          fill="none" stroke="#E5E7EB" stroke-dasharray="6,4" />
    <text x="225" y="50" text-anchor="middle"
          font-size="11" fill="#9CA3AF" font-weight="600"
          letter-spacing="0.06em">ZONA INTERIOAR&#258;</text>
    <text x="225" y="66" text-anchor="middle"
          font-size="10" fill="#D1D5DB">Sala Principal&#259;</text>
    ...
    <text x="665" y="66" text-anchor="middle"
          font-size="10" fill="#D1D5DB">Gr&#259;din&#259; &#537;i Teras&#259;</text>
  `;
